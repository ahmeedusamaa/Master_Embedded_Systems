...
#define SPI_NSS_HW_Slave_output_Enable				(uint16_t)(1<<2)
#define SPI_NSS_HW_Slave_output_Disable				(uint16_t)(0)
//NSS is Driven by SW
#define SPI_NSS_SW_ISE						     	(uint16_t)(1<<9) 			  //Internal slave enabled
#define SPI_NSS_SW_ISD							 	(uint16_t)(1<<9 | 1<<8)       //Internal slave disabled
...
//SPI_CR2 register
#define SPI_IRQ_Enable_define						 (uint16_t)(0)
